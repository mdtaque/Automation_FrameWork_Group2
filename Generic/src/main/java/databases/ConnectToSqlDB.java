...
public class ConnectToSqlDB {
    ...
    public void createTable (String tableName, String columnName, List<String> valueText) throws Exception{
        try {
            connectToMySQL();
            ...
            ps.executeUpdate();
            for(String st: valueText){
                String query3 = "insert into "+tableName+" values('"+valueText+"');";
